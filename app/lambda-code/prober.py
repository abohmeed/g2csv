...
def handler(event, context):
    ...
    notification = "The instance {} produced the following alarm: {} on {}. The top five running processes are: {}".format(instance_info['name'],alarm_message,alarm_time,'\n'.join(output))
    json_notification = json.dumps({"default":json.dumps(notification)})
